...
import { NftContextType } from "@sniper-monkey/types/build";
import {
	NftContext,
	NftProvider,
} from "../../components/filter/providers/nftFilters";
...
const Collection: NextPage = () => {
	...
	useEffect(() => {
		if (!slug || !nftContextData) return;
		loadCollection(slug, nftContextData.state).then((collectionData) => {
			setCollection(collectionData);
			console.log(collectionData);
		});
	}, [slug, nftContextData]);

	const columns = ["", "Name", "Rank", "Price", "Last sold", "Attributes"];
